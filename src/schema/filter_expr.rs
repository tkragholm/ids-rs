...
impl Expr {
    #[must_use] pub fn and(self, rhs: Self) -> Self {
        Self::And(Box::new(self), Box::new(rhs))
    }

    #[must_use] pub fn or(self, rhs: Self) -> Self {
...
#[must_use] pub fn col(name: &str) -> ColumnBuilder {
    ColumnBuilder {
        name: name.to_string(),
    }
}
...
impl ColumnBuilder {
    ...
    #[must_use] pub fn lt(self, val: i64) -> Expr {
        Expr::Filter {
            column: self.name,
    ...
    #[must_use] pub fn starts_with(self, val: &str) -> Expr {
        Expr::Filter {
            column: self.name,
    ...
    #[must_use] pub fn ends_with(self, val: &str) -> Expr {
        Expr::Filter {
            column: self.name,
    ...
    #[must_use] pub fn contains(self, val: &str) -> Expr {
        Expr::Filter {
            column: self.name,
