...
mod tests {
    ...
    #[test]
    fn test_parse_i32() {
        assert_eq!(StringParsingUtilsImpl::parse_i32("123", "Invalid number").unwrap(), 123);
        assert!(StringParsingUtilsImpl::parse_i32("abc", "Invalid number").is_err());
    }
    
    #[test]
    fn test_parse_f64() {
        assert_eq!(StringParsingUtilsImpl::parse_f64("123.45", "Invalid number").unwrap(), 123.45);
        assert!(StringParsingUtilsImpl::parse_f64("abc", "Invalid number").is_err());
    }
    
    #[test]
    fn test_parse_bool() {
        assert_eq!(StringParsingUtilsImpl::parse_bool("true", "Invalid boolean").unwrap(), true);
        assert_eq!(StringParsingUtilsImpl::parse_bool("yes", "Invalid boolean").unwrap(), true);
        assert_eq!(StringParsingUtilsImpl::parse_bool("1", "Invalid boolean").unwrap(), true);
        assert_eq!(StringParsingUtilsImpl::parse_bool("false", "Invalid boolean").unwrap(), false);
        assert_eq!(StringParsingUtilsImpl::parse_bool("no", "Invalid boolean").unwrap(), false);
        assert_eq!(StringParsingUtilsImpl::parse_bool("0", "Invalid boolean").unwrap(), false);
        assert!(StringParsingUtilsImpl::parse_bool("abc", "Invalid boolean").is_err());
    }
    
    #[test]
    fn test_parse_optional_i32() {
        assert_eq!(StringParsingUtilsImpl::parse_optional_i32("123", "Invalid number").unwrap(), Some(123));
        assert_eq!(StringParsingUtilsImpl::parse_optional_i32("", "Invalid number").unwrap(), None);
        assert_eq!(StringParsingUtilsImpl::parse_optional_i32("null", "Invalid number").unwrap(), None);
        assert!(StringParsingUtilsImpl::parse_optional_i32("abc", "Invalid number").is_err());
    }
    
    #[test]
    fn test_parse_optional_f64() {
        assert_eq!(StringParsingUtilsImpl::parse_optional_f64("123.45", "Invalid number").unwrap(), Some(123.45));
        assert_eq!(StringParsingUtilsImpl::parse_optional_f64("", "Invalid number").unwrap(), None);
        assert_eq!(StringParsingUtilsImpl::parse_optional_f64("null", "Invalid number").unwrap(), None);
