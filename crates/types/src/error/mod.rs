...
impl IdsError {
    ...
    pub fn invalid_criteria<T: ToString>(msg: T) -> Self {
...
// Implement ErrorContext for any Result where the error implements Display
...
pub mod prelude {
    pub use super::{IdsError, Result, ErrorContext};
}